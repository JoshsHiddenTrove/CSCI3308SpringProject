...
\copy recipe(name, picture, saved) FROM '~/ShareSync/CS/3308/project/recipesTableData.csv' DELIMITER ',' CSV; -- psql function to import/copy data from external csv file into the database
...
\copy stats(num_likes,num_dislikes) FROM '~/ShareSync/CS/3308/project/statsTableData.csv' DELIMITER ',' CSV;
...
\copy preferences(vegan, dairy_free, vegetarian, gluten_free, nut_free) FROM '~/ShareSync/CS/3308/project/preferencesTableData.csv' DELIMITER ',' CSV;
